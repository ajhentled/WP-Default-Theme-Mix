...
function scwd_scripts() {
	...
	// Main Styles
	wp_enqueue_style( 'scwd-main', get_template_directory_uri() . '/dist/css/main.css');
	...
	wp_enqueue_script( 'scwd-app', get_template_directory_uri() . '/dist/js/app.js', array('jquery'), '', true );
